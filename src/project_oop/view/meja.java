...
public class meja extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(meja.class.getName());
    private final String CARI_PLACEHOLDER = "Cari Meja";
    ...
    private void initComponents() {
        ...
        tabelDaftarMeja.setBackground(new java.awt.Color(252, 250, 248));
        tabelDaftarMeja.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabelDaftarMeja.setName(""); // NOI18N
        jScrollPane1.setViewportView(tabelDaftarMeja);
        ...
        jLabel2.setText("Daftar Meja Restoran");
        ...
        btnSideMeja.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/btn-sidebar-meja-aktif.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new meja().setVisible(true));
    }
    ...
    private javax.swing.JTable tabelDaftarMeja;
